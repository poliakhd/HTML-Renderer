...
namespace HtmlRenderer.Core.Core.Handlers
{
    /// <summary>
    ...
    internal sealed class SelectionHandler : IDisposable
    {
        ...
        /// <seealso cref="CalculateWordCharIndexAndOffset(HtmlRenderer.Core.Adapters.RControl,HtmlRenderer.Core.Core.Dom.CssRect,HtmlRenderer.Core.Adapters.Entities.RPoint,bool)"/>.
        /// </summary>
